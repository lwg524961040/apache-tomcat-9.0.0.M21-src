...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        Thread.currentThread().setContextClassLoader(catalinaLoader);//设置主线程的classLoader为catalinaLoader

        SecurityClassLoad.securityClassLoad(catalinaLoader);//设置安全管理的classLoader为catalinaLoader
